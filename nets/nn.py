...
class FPN(torch.nn.Module):
    def __init__(self, width):
        ...
        self.p4 = [Conv(width[3], width[2], torch.nn.ReLU(), 3, p=1), ConvTranspose(width[2], width[2], torch.nn.ReLU(), 4, 2, 1)]
        self.p3 = [Conv(width[2], width[1], torch.nn.ReLU(), 3, p=1), ConvTranspose(width[1], width[1], torch.nn.ReLU(), 4, 2, 1)]
        self.p2 = [Conv(width[1], width[0], torch.nn.ReLU(), 3, p=1), ConvTranspose(width[0], width[0], torch.nn.ReLU(), 4, 2, 1)]
